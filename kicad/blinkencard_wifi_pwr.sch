...
Rev "v2.0"
Comp "Andrew Litt"
Comment1 "WiFi module, power supplies, battery charging"
Comment2 ""
Comment3 ""
Comment4 ""
$EndDescr
...
F 4 " CL21A106KQCLRNC" H 3665 2546 50  0001 C CNN " mfg_part"
	1    3550 2400
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " MIC5504-1.2YM5" H 7150 5767 50  0001 C CNN " mfg_part"
	1    7150 5300
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " CL21B105KOFNNNG" H 6515 5746 50  0001 C CNN " mfg_part"
	1    6400 5600
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " CL21B105KOFNNNG" H 7815 5696 50  0001 C CNN " mfg_part"
	1    7700 5550
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " CL21A106KQCLRNC" H 8265 5696 50  0001 C CNN " mfg_part"
	1    8150 5550
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " CL21A106KQCLRNC" H 8965 5746 50  0001 C CNN " mfg_part"
	1    8850 5600
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " CL21A106KQCLRNC" H 10265 5696 50  0001 C CNN " mfg_part"
	1    10150 5550
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " AP7361C-33E-13" H 9500 5542 50  0001 C CNN " mfg_part"
	1    9500 5200
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " ESP32-WROOM-32D" H 2250 5700 50  0001 C CNN " mfg_part"
	1    2600 4150
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " 105017-0001" H 2807 1667 50  0001 C CNN " mfg_part"
	1    2750 1100
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " RC0603JR-0710KL" H 1468 2796 50  0001 C CNN " mfg_part"
	1    1400 2650
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " CL10F104ZO8NNNC" H 1515 3346 50  0001 C CNN " mfg_part"
	1    1400 3200
	-1   0    0    1   
$EndComp
$Comp
...
F 4 " 54202-S0804LF" H 5350 2717 50  0001 C CNN " mfg_part"
	1    5300 2300
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " NP" H 4008 1118 50  0001 C CNN " mfg_part"
	1    3950 900 
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " NP" H 4558 1118 50  0001 C CNN " mfg_part"
	1    4500 900 
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " DMG2301L-7" H 8706 3546 50  0001 C CNN " mfg_part"
	1    8500 3400
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " RC0603JR-07100KL" H 7768 3996 50  0001 C CNN " mfg_part"
	1    7700 3850
	1    0    0    -1  
$EndComp
$Comp
...
F 4 " B120-E3/61T" H 8050 3484 50  0001 C CNN " mfg_part"
	1    8050 3600
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5DE8EA4C
P 10100 1700
F 0 "J3" H 10018 1375 50  0000 C CNN
F 1 "Conn_01x02" H 10018 1466 50  0000 C CNN
F 2 "Connector_JST:JST_PH_S2B-PH-SM4-TB_1x02-1MP_P2.00mm_Horizontal" H 10100 1700 50  0001 C CNN
F 3 "~" H 10100 1700 50  0001 C CNN
F 4 " S2B-PH-SM4-TB(LF)(SN)" H 10018 1475 50  0001 C CNN " mfg_part"
	1    10100 1700
	1    0    0    1   
$EndComp
$Comp
...
U 1 1 5DE92DA4
P 9650 1900
F 0 "#PWR0103" H 9650 1650 50  0001 C CNN
...
U 1 1 5DE98126
P 7700 3150
F 0 "#PWR0104" H 7700 3000 50  0001 C CNN
...
U 1 1 5DEAD03E
P 8300 1700
F 0 "U5" H 8100 2000 50  0000 C CNN
F 1 "MCP73831-2-OT" H 8650 1400 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23-5" H 8350 1450 50  0001 L CIN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/20001984g.pdf" H 8150 1650 50  0001 C CNN
F 4 " MCP73831T-2ATI/OT" H 8100 2100 50  0001 C CNN " mfg_part"
	1    8300 1700
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5DEC5053
P 9650 1400
F 0 "#PWR0112" H 9650 1250 50  0001 C CNN
F 1 "+BATT" H 9665 1573 50  0000 C CNN
...
U 1 1 5DEC7638
P 8300 1250
F 0 "#PWR0113" H 8300 1100 50  0001 C CNN
...
U 1 1 5DEC9660
P 8300 2250
F 0 "#PWR0114" H 8300 2000 50  0001 C CNN
...
U 1 1 5DECB7EF
P 7700 1950
F 0 "R9" H 7632 1904 50  0000 R CNN
F 1 "10K" H 7632 1995 50  0000 R CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 7740 1940 50  0001 C CNN
F 3 "~" H 7700 1950 50  0001 C CNN
F 4 " RC0603JR-0710KL" H 7632 2004 50  0001 C CNN " mfg_part"
	1    7700 1950
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5DED3FBB
P 9200 1750
F 0 "C16" H 9315 1796 50  0000 L CNN
F 1 "10.0uF" H 9315 1705 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric" H 9238 1600 50  0001 C CNN
F 3 "~" H 9200 1750 50  0001 C CNN
F 4 " CL21A106KQCLRNC" H 9315 1896 50  0001 C CNN " mfg_part"
	1    9200 1750
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5DEE1A99
P 9200 2000
F 0 "#PWR0115" H 9200 1750 50  0001 C CNN
...
U 1 1 5DEE704D
P 8900 1350
F 0 "D2" V 8946 1282 50  0000 R CNN
F 1 "LED_Small" V 8855 1282 50  0000 R CNN
F 2 "LED_SMD:LED_0805_2012Metric" V 8900 1350 50  0001 C CNN
F 3 "~" V 8900 1350 50  0001 C CNN
F 4 " LTST-S220GKT" H 8946 1382 50  0001 C CNN " mfg_part"
	1    8900 1350
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5DEEAB8F
P 8900 1000
F 0 "R18" H 8832 954 50  0000 R CNN
F 1 "1K" H 8832 1045 50  0000 R CNN
F 2 "Resistor_SMD:R_0603_1608Metric" V 8940 990 50  0001 C CNN
F 3 "~" H 8900 1000 50  0001 C CNN
F 4 " RC0603JR-071KL" H 8832 1054 50  0001 C CNN " mfg_part"
	1    8900 1000
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5DEEAF38
P 8900 750
F 0 "#PWR0116" H 8900 600 50  0001 C CNN
...
F 4 " JS102011SAQN" H 9550 3935 50  0001 C CNN " mfg_part"
	1    9550 3600
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5DFB6317
P 7550 1500
F 0 "C19" H 7665 1546 50  0000 L CNN
F 1 "10.0uF" H 7665 1455 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric" H 7588 1350 50  0001 C CNN
F 3 "~" H 7550 1500 50  0001 C CNN
F 4 " CL21A106KQCLRNC" H 7665 1646 50  0001 C CNN " mfg_part"
	1    7550 1500
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5DFB6E84
P 7550 1650
F 0 "#PWR028" H 7550 1400 50  0001 C CNN
...
ICE40UP5K requires 1.2V core rail up before 3.3V.\nWe fudge this by assuming that the ramp on VPP\ncauses the 1.2V LDO to hit the target voltage before 3.3.
...
Connector for ESP-01 style UART adapter.\nIntended to use with a no-pop header during\ndevelopment or pogo pins for production
Text Label 8700 3600 0    50   ~ 0
UNSWITCHED_VPP
Text Notes 8500 4000 0    50   ~ 0
External/battery power switch. Lifted from\nAdafruit's ESP32 Feather design.
...
Wire Wire Line
	7700 3150 7700 3400
Wire Notes Line
	7500 2850 10500 2850
Wire Notes Line
	10500 2850 10500 4400
Wire Notes Line
	10500 4400 7500 4400
Wire Notes Line
	7500 4400 7500 2850
Wire Notes Line
	6400 1550 6400 2600

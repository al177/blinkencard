...
CAVITY_DEPTH = 8.6; // depth in case behind the PCB
...
// special standoff for left and large bat
translate([PERIMETER_THICKNESS, PERIMETER_THICKNESS, BOTTOM_WALL_THICKNESS]) cube([1, CAVITY_LENGTH, CAVITY_DEPTH]);
